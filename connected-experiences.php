...
/**
 *
 * Template Name: Connected Experiences
 *
...
#security_protection_of_privacy .container-managed-uno .izqparrafo  p span{
    color: #0f88d6;
...
#discover_define .container-connected-dos {
...
#security_protection_of_privacy .container-connected-dos {
    padding-top: 40px !important;
    min-height: 787px;
...
#security_protection_of_privacy .container-managed-uno {
...
#security_protection_of_privacy {
    min-height: 1000px;
}
...
#security_protection_of_privacy .container-connected-dos .tit-cat-podcast-int-box {
 margin-bottom: 7px;
}
.container-apprefresh {
 height: 770px;
...
$('#WS-SL--content').WS_ScroLi({
        ...
        sections: [
            ['#discover_define', '<a href="#discover_define">Discover &<br/>Define</a>'],
            ['#design_development', '<a href="#design_development">Design<br/> Development</a>'],
            ['#security_protection_of_privacy','<a href="#security_protection_of_privacy">Security & <br/>Protection of <br/>Privacy</a>'],
            ['#data_analytics', '<a href="#data_analytics">Data &<br/> Analytics</a>']
        ],
        position: {
            x: ['left', 'auto'],
            y: ['top', 110]
