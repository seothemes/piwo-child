...
#WS-ScroLi .item-8 .line, #WS-ScroLi .item-8 .line-animation {
    display: none !important;
}
...
$(function() {
    ...
    $('#WS-SL--content').WS_ScroLi({
        ...
        sections: [
            ['#cybersecurity','<a href="#cybersecurity">Cybersecurity</a>'],
            ['#governance','<a href="#governance">Governance, Risk & Compliance</a>'],
            ['#threat_defense','<a href="#threat_defense">Threat</br>Defense</a>'],
            ['#identity','<a href="#identity">Identity & Access Management</a>'],
            ['#infra_cloud_sec','<a href="#infra_cloud_sec">Infrastructure & Cloud</a>'],
            ['#data_app','<a href="#data_app">Data & Application</a>'],
            ['#endpoint','<a href="#endpoint">Endpoint</a>'],
            ['#detection_response','<a href="#detection_response">Detection & Response</a>']
        ],
        position: {
            x: ['left', 'auto'],
            y: ['top', 100]
