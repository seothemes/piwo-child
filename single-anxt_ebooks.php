<?php
/**
 * The template for displaying all single ebooks pages
 *
...
<style>
	...
	.form-styles .lp-form-header p{
		...
		.postid-58503 .ebook-title h2{
			color:#3C3D47;
		}
		.postid-58503 .content p{
			color:#3C3D47 !important;
		}
		.postid-58503 .content ul{
			color:#3C3D47 !important;
		}
		.single-anxt_ebooks .content p{
			color:#FFF;
		}
