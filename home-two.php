...
<section class="x-background container-fluid">
	...
	<div class="service-text-one icon" data-aos="zoom-in">
		...
		<h3>Accelerate automation, standardization, scalability, and agility in the Public Cloud or your on-premises
			Data Center. </h3>
		<div class="circle-a">
	...
	<div class="service-text-two icon" data-aos="zoom-in">
		...
		<h3>Engage customers and employees across the entire journey and deliver a digital ecosystem of multi-channel
			services and experiences.</h3>
		<div class="circle-a">
	...
	<div class="service-text-three icon" data-aos="zoom-in">
		...
		<h3>Ward off threats to your applications, data, and infrastructure at every layer via our holistic security
			approach</h3>
		<div class="circle-a">
	...
	<div class="service-text-four icon" data-aos="zoom-in">
		...
		<h2>Data Center</h2>
		<h3>Ensure best-in-breed Data Center Modernization solutions across computing, network, and storage thanks to
			our elite technology partnerships.</h3>
		<div class="circle-a">
	...
	<div class="service-text-six icon" data-aos="zoom-in">
		...
		<h2>Networking</h2>
		<h3>Modernize your network for increased stability and scalability and to ensure the security of cloud data and
			remote workforces. </h3>
		<div class="circle-a">
	...
	<div class="service-text-seven icon" data-aos="zoom-in">
		...
		<h3>Engineer game-changing platforms and applications to generate compelling experiences and uncover new revenue
			streams.​</h3>
		<div class="circle-a">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 text-cont" data-aos="zoom-in">
				...
				<h3>As a leading technology consultancy and reseller, Anexinet helps clients achieve digital and
					infrastructure transformation.</h3>
				<div class="a-cont">
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div class="text-cont" data-aos="zoom-in">
					...
					<p>We’re able to deliver great, comprehensive digital experiences thanks to our partnerships with
						these leading technology vendors:</p>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form" id="main_form" data-aos="zoom-in">
						<div data-form-block-id="049dc2e8-73c0-ea11-a812-000d3a33243a"></div>
						<div id="dETKvCv7CyC0MsH0kAoRKsP3-3yAVlfPFhIGnRNXRvZ0"></div>
	...
	! function( e ) {
		...
		n.m = e, n.c = t, n.d = function( e, t, r ) {
			...
			if ( n.r( r ), Object.defineProperty( r, 'default', {
				enumerable: ! 0,
				value: e
			} ), 2 & t && 'string' != typeof e ) for ( var a in e ) n.d( r, a, function( t ) {return e[ t ];}.bind( null, a ) );
			return r;
		}, n.n = function( e ) {
			var t = e && e.__esModule ? function() {return e.default;} : function() {return e;};
			return n.d( t, 'a', t ), t;
		}, n.o = function( e, t ) {return Object.prototype.hasOwnProperty.call( e, t );}, n.p = '/', n( n.s = 2 );
		...
		new ( function() {
			...
			return t = e, ( n = [ {
				...
				value: function() {
					var e = this, t = document.querySelectorAll( '.purecounter' );
					if ( this.intersectionListenerSupported() ) for ( var n = new IntersectionObserver( this.animateElements.bind( this ), {
						root: null,
						rootMargin: '20px',
						threshold: .5
					} ), r                                                  = 0; r < t.length; r ++ ) n.observe( t[ r ] ); else window.addEventListener && ( this.animateLegacy( t ), window.addEventListener( 'scroll', function( n ) {e.animateLegacy( t );}, { passive: ! 0 } ) );
				}
			}, {
				key: 'animateLegacy',
				value: function( e ) {for ( var t = 0; t < e.length; t ++ ) {! 0 === this.parseConfig( e[ t ] ).legacy && this.elementIsInView( e[ t ] ) && this.animateElements( [ e[ t ] ] );}}
			}, {
				key: 'animateElements', value: function( e, t ) {
					var n = this;
					e.forEach( function( e ) {
						var r = void 0 !== e.target ? n.parseConfig( e.target ) : n.parseConfig( e );
						return r.duration <= 0 ? e.innerHTML = r.end.toFixed( r.decimals ) : ! t && ! n.elementIsInView( e ) || t && e.intersectionRatio < .5 ? e.target.innerHTML = r.start > r.end ? r.end : r.start : void setTimeout( function() {return void 0 !== e.target ? n.startCounter( e.target, r ) : n.startCounter( e, r );}, r.delay );
					} );
				}
			}, {
				key: 'startCounter',
				value: function( e, t ) {
					var n = this, r = ( t.end - t.start ) / ( t.duration / t.delay ), a = 'inc';
				...
				key: 'parseConfig',
				value: function( e ) {
					for ( var t = [].filter.call( e.attributes, function( e ) {return /^data-purecounter-/.test( e.name );} ), n = {
						start: 0,
						end: 9001,
						duration: 2e3,
						delay: 10,
				...
				key: 'nextNumber',
				value: function( e, t, n, r ) {return r || ( r = 'inc' ), 'inc' === r ? n.decimals <= 0 ? parseInt( e ) + parseInt( t ) : parseFloat( e ) + parseFloat( t ) : n.decimals <= 0 ? parseInt( e ) - parseInt( t ) : parseFloat( e ) - parseFloat( t );}
			}, {
				key: 'formatNumber',
				value: function( e, t ) {
				...
				key: 'castDataType',
				value: function( e ) {return /^[0-9]+\.[0-9]+$/.test( e ) ? parseFloat( e ) : /^[0-9]+$/.test( e ) ? parseInt( e ) : e;}
			}, {
				key: 'elementIsInView',
				value: function( e ) {
				...
				value: function() {return 'IntersectionObserver' in window && 'IntersectionObserverEntry' in window && 'intersectionRatio' in window.IntersectionObserverEntry.prototype;}
