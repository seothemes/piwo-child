...
/**
 *
 * Template Name: Partners new Template 2020
 *
  ...
  <section class="part-main-cont">
    ...
    <div class="text-cont">
      <div class="h2-cont">
        ...
        <!-- <p>You get to be the best by partnering with the best.</p> -->
        </div>
      </div>
    </div>
...
<!-- Section 2 End -->
<!-- Section 2 Begin -->
<!-- <section class="part-third-cont">
  <div class="part-prem-cont container">
    <p>Premium Partners</p>
  <div class="row">
    <div class="container part-img-cont">

      <div class="col-md-3 spprt-class">
        <div class="part-frst-img">
          <img src="https://www.anexinet.com/wp-content/uploads/2018/07/im-logo-aws.png" style="width: 125px;" alt="Amazon Web Services Premium Partner Image">
        </div>
      </div>

      <div class="col-md-3 spprt-class">
        <div class="part-frst-img">
          <img src="https://www.anexinet.com/wp-content/uploads/2020/02/dell-premium-x2.png" alt="Dell Premium Partner Image">
        </div>
      </div>

      <div class="col-md-3 spprt-class">
        <div class="part-frst-img">
          <img src="https://www.anexinet.com/wp-content/uploads/2018/07/im-logo-micro-copy@2x.png" style="max-width: 170px;" alt="Microsoft Premium Partner Image">
        </div>
      </div>

      <div class="col-md-3 spprt-class">
        <div class="part-frst-img">
          <img src="/wp-content/uploads/2020/02/G_PM_PR_PLAT_PAR_RGB_DIGITAL.png" alt="HP Partner Image">
        </div>
      </div>
