...
/**
 *
 * Template Name: Product Innovation
 *
...
<?php
  ...
  .link-white i{
   ...
   .img-text-bottom-related .single-gray{
    font-weight:600;
  }
  .img-text-bottom-related .single-blue{
    font-weight:600;
  }
  .strategy-led h4{
    font-size: 30px;
...
.design-innovation .bg-img h3{
  color: white;
  font-size: 18px;
  font-weight: 600;
}

.design-innovation .bg-img p{
   color: white;
   font-weight: 600;
   font-size: 18px;
   max-width: 200px;
...
@media screen and (max-width:1214px){
	.rapid-prototyping .col-md-7{
      ...
      .img-text-bottom-related .dflex-column{
        max-width: 350px;
      }
...
.social-listening .img-bg{
  background-image: url('/wp-content/uploads/2020/08/bitmap-2.jpg');
  background-repeat: no-repeat;
  padding: 20px;
  display: flex;
  flex-direction: column;
...
.design-innovation .bg-img{
  background-image: url('https://www.anexinet.com/wp-content/uploads/2020/08/bitmap@2x.jpg');
  background-repeat: no-repeat;
  background-size: cover;
  display: flex;
  flex-direction: column;
...
$(function() {
    ...
    $('#WS-SL--content').WS_ScroLi({
        ...
        sections: [
            ['#product-innovation','<a href="#product-innovation">Product innovation</a>'],
            ['#strategy_led_innovation','<a href="#strategy_led_innovation">Strategy Led Innovation</a>'],
            ['#designing_for_innovation','<a href="#designing_for_innovation">Designing For Innovation</a>'],
            ['#rapid_prototyping','<a href="#rapid_prototyping ">Rapid Prototyping</a>'],
						['#technical_foundation','<a href="#technical_foundation ">Technical Foundation</a>'],
						['#smarter_products','<a href="#smarter_products ">Smarter Products</a>']
        ],
        position: {
            x: ['left', 'auto'],
            y: ['top', 100]
