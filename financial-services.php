...
.financial-services .col-md-4 .bg-rectangle{
...
.financial-services, .strategy-kickstart, .data-app-security .col-md-4 .bg-rectangle .title{
    font-size: 12px;
    color:white;
}
...
$(function() {
    ...
    $('#WS-SL--content').WS_ScroLi({
        ...
        sections: [
            ['#financial_services','<a href="#financial_services">Financial Services</a>'],
